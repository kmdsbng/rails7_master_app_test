...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference("Country.count") do
      post countries_url, params: { country: { name: @country.name, name_en: @country.name_en } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { name: @country.name, name_en: @country.name_en } }
